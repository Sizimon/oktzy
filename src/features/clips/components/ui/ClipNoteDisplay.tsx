        ...
        <div className='p-4 rounded-2xl w-full h-full flex flex-col'>
            {timestamps.length === 0 ? (
                <div className='p-4 rounded text-text'>
                    ...
                    <Accordion type="single" collapsible className="w-full flex-1 overflow-y-auto" defaultValue='ERROR'>
                            ...
                            <AccordionItem key={index} value={`item-${index}`}>
                                ...
                                <AccordionContent>
                                    <div className="justify-center items-center w-full bg-foreground p-4 rounded">
                                        <p className="whitespace-pre-wrap text-start">{timestamp.note}</p>
                                    </div>
                                </AccordionContent>
                            </AccordionItem>
                        ))}
